    ...
    def _get_tensor_parallel_mappings(cls, config, is_split=True):
        ...
        def get_tensor_parallel_split_mappings(num_hidden_layers):
            ...
            base_actions = {
                ...
                "mgen.h.0.mlp.w2.weight": partial(fn, is_column=True),
                "mgen.h.0.mlp.w1.weight": partial(fn, is_column=True),
                "mgen.h.0.attn.c_attn.weight": partial(fn, is_column=True, is_naive_3fuse=True),
                "mgen.h.0.attn.c_attn.bias": partial(fn, is_column=True, is_naive_3fuse=True),
                # Row Linear
                "mgen.wte.weight": partial(fn, is_column=False),
                "mgen.h.0.mlp.c_proj.weight": partial(fn, is_column=False),
                "mgen.h.0.attn.c_proj.weight": partial(fn, is_column=False),
            }
